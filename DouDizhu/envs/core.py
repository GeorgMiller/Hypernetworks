...
class Card(object):
    ...
    Note:
        The suit variable in a standard card doudizhu should be one of [S, H, D, C, BJ, RJ] meaning [Spades, Hearts, Diamonds, Clubs, Black Joker, Red Joker]
...
class Dealer(object):
    ...
    Note: deck variable means all the cards in a single doudizhu, and should be a list of Card objects.
    '''
    ...
    def __init__(self):
        '''
        The dealer should have all the cards at the beginning of a doudizhu
        '''
...
class Judger(object):
    '''
    Judger decides whether the round/doudizhu ends and return the winner of the round/doudizhu
    '''
    ...
    def judge_game(self, **kwargs):
        '''
        Decide whether the doudizhu ends, and return the winner of the doudizhu

        Returns:
            int: return the player's id who wins the doudizhu or -1 meaning the doudizhu has not ended
        '''
        raise NotImplementedError
...
class Round(object):
    '''
    Round stores the id the ongoing round and can call other Classes' functions to keep the doudizhu running
    '''

    def __init__(self):
        '''
        When the doudizhu starts, round id should be 1
        '''
    ...
    def proceed_round(self, **kwargs):
        '''
        Call other Classes's functions to keep the doudizhu running
        '''
        raise NotImplementedError
...
class Game(object):
    ...
    def init_game(self):
        '''
        Initialize all characters in the doudizhu and start round 1
        '''
        raise NotImplementedError

    def step(self, action):
        '''
        Perform one draw of the doudizhu and return next player number, and the state for next player
        '''
        raise NotImplementedError
    ...
    def get_player_num(self):
        '''
        Retrun the number of players in the doudizhu
        '''
        raise NotImplementedError

    def get_action_num(self):
        '''
        Return the number of possible actions in the doudizhu
        '''
        raise NotImplementedError
    ...
    def is_over(self):
        '''
        Return whether the current doudizhu is over
        '''
        raise NotImplementedError
