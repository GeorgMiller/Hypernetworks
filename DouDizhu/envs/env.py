...
class Env(object):
    ...
    def __init__(self, config):
        ...
        # TODO support doudizhu configurations for all the games
        ...
        # Get the number of players/actions in this doudizhu
    ...
    def run(self, is_training=False):
        ...
        # TODO: reshape the reward, -(number of len(currenthand))
