...
from utils_global import get_downstream_player_id, get_upstream_player_id


class DoudizhuGame(object):
    '''
    Provide doudizhu APIs for env to run doudizhu and get corresponding state
    information.
    ...
    def init_game(self):
        ...
        Returns:
            dict: first state in one doudizhu
    ...
    def step(self, action):
        '''
        Perform one draw of the doudizhu
        ...
        if self.allow_step_back:
            # TODO: don't record doudizhu.round, doudizhu.players, doudizhu.judger if allow_step_back not set
            pass
    ...
    def step_back(self):
        '''
        Return to the previous state of the doudizhu

        Returns:
            (bool): True if the doudizhu steps back successfully
        '''
    ...
    def is_over(self):
        '''
        Judge whether a doudizhu is over
    ...
    def get_payoffs(self):
        ...
        '''
        return self.judger.judge_payoffs(self.round.landlord_id, self.winner_id)

    def get_winner_id(self):
        payoff = self.get_payoffs()
