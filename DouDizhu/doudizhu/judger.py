...
class DoudizhuJudger(object):
    ...
    def solo_attachments(cls, hands, chain_start, chain_length, size):
        ...
        Returns:
            list of tuples: [attachment1, attachment2, ...]
                            Each attachment has two elements,
        ...
        for card in hands:
            ...
            if card == prev_card:
                ...
                # attachments can not have 3 same cards consecutive with the trio (except 3 cards of '222')
                        ...
                        and (CARD_RANK_STR_INDEX[card] == chain_start - 1 or CARD_RANK_STR_INDEX[card] == chain_start + chain_length) \
                        and card != '2':
                    continue
                else:
                    same_card_count += 1
    ...
    def playable_cards_from_hand(current_hand):
        ...
        # trio_solo, trio_pair,
        # trio -- trio_chain_2 -- trio_chain_6;
    ...
    def restore_playable_cards(self, player_id):
        '''
        restore playable_cards for judger for doudizhu.step_back().
    ...
    def judge_game(players, player_id):
        '''
        Judge whether the doudizhu is over
        ...
        Returns:
            (bool): True if the doudizhu is over
        '''
